...
const DiscardedInvoice = () => {
  ...
  const loadInvoiceData = async () => {
    try {
      ...
      const data = await window.electronAPI.getAllDiscardedBloodInvoices();
      setInvoiceData(data);
    } catch (err) {
  ...
  const getSortLabel = () => {
    const labels = {
      ...
      reasonForDiscarding: "Reason for Discarding",
      dateOfDiscard: "Date of Discard",
  ...
  const filteredData = invoiceData.filter(
    (item) =>
      ...
      item.responsiblePersonnel
        ?.toLowerCase()
        .includes(searchTerm.toLowerCase()) ||
      item.reasonForDiscarding
        ?.toLowerCase()
        .includes(searchTerm.toLowerCase()) ||
      item.authorizedBy?.toLowerCase().includes(searchTerm.toLowerCase()) ||
      item.methodOfDisposal?.toLowerCase().includes(searchTerm.toLowerCase())
  );
  ...
  const handleDelete = async () => {
    try {
      ...
      await window.electronAPI.deleteDiscardedBloodInvoices(selectedIds);
  ...
  const handleViewInvoice = async (invoiceId) => {
    try {
      ...
      const invoiceDetails =
        await window.electronAPI.viewDiscardedBloodInvoice(invoiceId);
  ...
  const generateInvoicePDF = () => {
    ...
    // Use the reference number directly from header
    ...
    const maxRefWidth = 8.0 - refTextStartX; // Max width to right margin (8.5 - 0.5 margin)
    
    // Get actual width of reference text
    let refWidth = doc.getTextWidth(refText);
    
    // If text is too long, reduce font size to fit on single line
    if (refWidth > maxRefWidth) {
      ...
      doc.setFontSize(currentFontSize); // Reset to original font size
    } else {
      doc.text(refText, refTextStartX, 2.1);
    }
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <h1 style={styles.title}>Discarded Blood Invoice</h1>
        <p style={styles.subtitle}>Discarded Non-Conforming Unit Form</p>
      </div>
            ...
            {showSortDropdown && (
              ...
              >
                {[
                  ...
                  {
                    key: "reasonForDiscarding",
                    label: "Reason for Discarding",
                  },
                  { key: "dateOfDiscard", label: "Date of Discard" },
                  { key: "authorizedBy", label: "Authorized By" },
                  { key: "methodOfDisposal", label: "Method of Disposal" },
                ].map((item) => (
                  <div
                    key={item.key}
                    style={{
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <option value="responsiblePersonnel">
                        Responsible Personnel
                      </option>
                      <option value="reasonForDiscarding">
                        Reason for Discarding
                      </option>
                      <option value="authorizedBy">Authorized By</option>
                      <option value="methodOfDisposal">
                        Method of Disposal
                      </option>
                    </select>
                  </div>
        ...
        <table style={styles.table}>
          <thead style={styles.thead}>
            <tr>
              ...
              <th style={{ ...styles.th, width: "10%" }}>DATE OF DISCARD</th>
              <th style={{ ...styles.th, width: "12%" }}>AUTHORIZED BY</th>
              <th style={{ ...styles.th, width: "12%" }}>METHOD OF DISPOSAL</th>
              <th style={{ ...styles.th, width: "13%" }}>REFERENCE NO.</th>
            ...
            {displayData.length === 0 ? (
              ...
              displayData.map((item, index) => (
                ...
                >
                  ...
                  <td style={styles.td}>{item.responsiblePersonnel}</td>
                  <td style={styles.td}>{item.reasonForDiscarding}</td>
                  <td style={styles.td}>{item.dateOfDiscard}</td>
                  <td style={styles.td}>{item.authorizedBy}</td>
                  <td style={styles.td}>{item.methodOfDisposal}</td>
          ...
          >
            ...
            >
              ...
              <div style={{ textAlign: "center" }}>
                ...
                >
                  Are you sure you want to delete {selectedCount} invoice
      ...
      {showDeleteSuccessModal && (
        <div style={styles.successModalOverlay}>
          <div style={styles.successModal}>
            ...
            <h3 style={styles.successTitle}>{deleteSuccessMessage.title}</h3>
            ...
            <button
              style={{
                ...
                ...(hoverStates.deleteSuccessOk
                  ? styles.successOkButtonHover
                  : {}),
              }}
              onClick={() => setShowDeleteSuccessModal(false)}
          ...
          >
            ...
            <div style={styles.modalContent}>
              <div style={styles.previewContainer}>
                ...
                {/* Info Section - Date and Reference Number */}
                <div style={styles.infoRow}>
                  <div>
                    <span style={styles.infoLabel}>Date of Discard: </span>
                    <span
                      style={{
                        borderBottom: "1px solid #000",
                        display: "inline-block",
                  ...
                  <div>
                    <span style={styles.infoLabel}>Reference no.: </span>
                    <span
                      style={{
                        borderBottom: "1px solid #000",
                        display: "inline-block",
                ...
                >
                  <span style={styles.infoLabel}>Responsible Personnel: </span>
                  <span
                    style={{
                      borderBottom: "1px solid #000",
                      display: "inline-block",
                  ...
                  <tbody>
                    {previewInvoice.items.map((item, index) => (
                      <tr key={index}>
                        ...
                        <td style={styles.tableCell}>{item.serialId}</td>
                        ...
                        <td style={styles.tableCell}>{item.volume} ML</td>
                ...
                {/* Reason for Discarding - BELOW THE TABLE */}
                <div
                  style={{
                    marginTop: "15px",
                    marginBottom: "20px",
                ...
                >
                  <span style={styles.infoLabel}>Reason for Discarding: </span>
                  <span
                    style={{
                      borderBottom: "1px solid #000",
                      display: "inline-block",
                ...
                >
                  <div style={{ width: "45%" }}>
                    ...
                    <div>
                      ...
                      <div style={{ marginTop: "15px" }}>
                        {previewInvoice.header.authorizedBy || ""}
                      </div>
                      <div
                        style={{
                          borderBottom: "1px solid #000",
                  ...
                  <div style={{ width: "45%" }}>
                    <div>
                      ...
                      <div style={{ marginTop: "15px" }}>
                        {previewInvoice.header.methodOfDisposal || ""}
                      </div>
                      <div
                        style={{
                          borderBottom: "1px solid #000",
                ...
                >
                  <strong>NOTE:</strong> All discarded units have been properly
                  disposed following DOH guidelines and regulations.
                </div>
              </div>
            </div>
...
export default DiscardedInvoice;