...
const PlateletNC = () => {
  ...
  const loadNonConformingData = async () => {
    try {
      ...
      const data = await window.electronAPI.getAllPlateletNonConforming();
      setBloodData(data);
    } catch (err) {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      if (value.trim() === "") {
        ...
        const searchResults =
          await window.electronAPI.searchPlateletNonConforming(value);
  ...
  const calculateExpiration = (collectionDate) => {
    ...
    expiration.setDate(collection.getDate() + 5); // Platelet shelf life is 5 days
    ...
    if (field === "serialId") {
      ...
      searchTimeoutsRef.current[index] = setTimeout(async () => {
        try {
          ...
          const stockData =
            await window.electronAPI.getPlateletStockBySerialIdForNC(
              value.trim()
            );
          ...
          if (
            ...
            const plateletMatch = stockData.find(
              (item) => item.category === "Platelet"
            );
                ...
                prev.map((item, i) =>
                  i === index
                    ? {
                        ...item,
                        serialId: value.trim(),
                        bloodType: plateletMatch.type,
                        rhFactor: plateletMatch.rhFactor,
                        volume: plateletMatch.volume,
                        collection: plateletMatch.collection,
    ...
    if (field === "serialId") {
      ...
      searchTimeoutsRef.current[`discard-${index}`] = setTimeout(async () => {
        try {
          ...
          const ncData =
            await window.electronAPI.getPlateletNonConformingBySerialIdForDiscard(
              value.trim()
            );
          ...
          if (
            ...
            const plateletMatch = ncData.find(
              (item) => item.category === "Platelet"
            );
            ...
            if (plateletMatch) {
              ...
              setError(
                `No Platelet non-conforming stock found with serial ID: ${value.trim()}`
              );
            }
          } else {
            setDiscardItems((prev) =>
          ...
          console.error(
            "Error fetching platelet non-conforming stock by serial ID:",
            err
          );
          setError("Failed to fetch platelet non-conforming stock data");
          setDiscardItems((prev) =>
            prev.map((item, i) =>
              i === index ? { ...item, found: false } : item
            )
    ...
    try {
      ...
      if (result.success) {
        ...
        setSuccessMessage({
          ...
          description: `${result.discardedCount} platelet unit(s) have been successfully discarded.`,
        });
        setShowSuccessModal(true);
      }
    } catch (err) {
      console.error("Error discarding platelet non-conforming stock:", err);
      setDiscardValidationErrors({
        save: `Failed to discard platelet non-conforming stock: ${err.message}`,
      });
    } finally {
      setSaving(false);
    }
  ...
  const handleSaveAllStock = async (e) => {
    ...
    try {
      ...
      if (errorMessage.includes("already exists")) {
        ...
        setValidationErrors({
          save: `Failed to transfer platelet to non-conforming: ${errorMessage}`,
        });
      }
    } finally {
      setSaving(false);
  ...
  const handleSaveEdit = async (e) => {
    ...
    try {
      ...
      if (errorMessage.includes("already exists")) {
        ...
        setEditValidationErrors({
          save: `Failed to update platelet non-conforming record: ${errorMessage}`,
        });
      }
    } finally {
      setSaving(false);
  ...
  const confirmEdit = async () => {
    try {
      ...
      console.error("Error updating platelet non-conforming record:", err);
      setError(
        `Failed to update platelet non-conforming record: ${err.message}`
      );
      setShowEditConfirmModal(false);
    } finally {
      setSaving(false);
          ...
          <tbody style={styles.tbody}>
            {displayData.length === 0 ? (
              <tr>
                ...
                >
                  No platelet non-conforming records found
                </td>
              </tr>
            ) : (
        ...
        <div style={styles.successModalOverlay}>
          <div style={styles.confirmModal}>
            ...
            <p style={styles.confirmDescription}>
              Are you sure you want to update this platelet non-conforming
              record?
            </p>
        ...
        >
          <div className="dialog-content">
            ...
            <div className="dialog-actions">
              <button className="dialog-button cancel-button" onClick={() => setShowDeleteConfirmModal(false)} disabled={saving}>
                Cancel
              </button>
              <button className="dialog-button delete-confirm-button" onClick={confirmDelete} disabled={saving}>
              ...
              <div style={styles.filterContainer}>
                <div style={styles.formGroup}>
                  ...
                  <input
                    ...
                    style={{
                      ...styles.fieldInput,
                      borderColor: discardValidationErrors.responsiblePersonnel
                        ? "#ef4444"
                        : "#d1d5db",
                    }}
                    value={discardFormData.responsiblePersonnel}
                    onChange={(e) =>
                      handleDiscardFormDataChange(
                        "responsiblePersonnel",
                        e.target.value
                      )
                    }
                ...
                <div style={styles.formGroup}>
                  ...
                  <select
                    style={{
                      ...styles.fieldSelect,
                      borderColor: discardValidationErrors.reasonForDiscarding
                        ? "#ef4444"
                        : "#d1d5db",
                    }}
              ...
              <div style={styles.filterContainer}>
                <div style={styles.formGroup}>
                  ...
                  <input
                    ...
                    style={{
                      ...styles.fieldInput,
                      borderColor: discardValidationErrors.authorizedBy
                        ? "#ef4444"
                        : "#d1d5db",
                    }}
                ...
                <div style={styles.formGroup}>
                  ...
                  <input
                    ...
                    style={{
                      ...styles.fieldInput,
                      borderColor: discardValidationErrors.dateOfDiscard
                        ? "#ef4444"
                        : "#d1d5db",
                    }}
              ...
              <div style={styles.filterContainer}>
                <div style={styles.formGroup}>
                  ...
                  <input
                    ...
                    style={{
                      ...styles.fieldInput,
                      borderColor: discardValidationErrors.timeOfDiscard
                        ? "#ef4444"
                        : "#d1d5db",
                    }}
                ...
                <div style={styles.formGroup}>
                  ...
                  <select
                    style={{
                      ...styles.fieldSelect,
                      borderColor: discardValidationErrors.methodOfDisposal
                        ? "#ef4444"
                        : "#d1d5db",
                    }}
                ...
                >
                  ...
                  <div>
                    ...
                    {Object.entries(discardValidationErrors)
                      .filter(
                        ([key]) => !["api", "save", "items"].includes(key)
                      )
                      .map(([key, message]) => (
            ...
            <div style={styles.modalContent}>
              ...
              >
                <input
                  ...
                  style={{
                    ...styles.fieldInput,
                    borderColor: editValidationErrors.serial_id
                      ? "#ef4444"
                      : "#d1d5db",
                  }}
                ...
                <input
                  ...
                  style={{
                    ...styles.fieldInput,
                    borderColor: editValidationErrors.collection
                      ? "#ef4444"
                      : "#d1d5db",
                  }}
