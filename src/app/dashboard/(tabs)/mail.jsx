  ...
  return (
    <div className="mail-content">
            ...
            <div className="mail-detail-header">
              ...
              <div className="mail-detail-actions">
                ...
                <button
                  ...
                  onClick={(e) => handleDeleteClick(selectedMail.id, e)}
                  title="Delete"
                >
                  <Trash2 size={18} />
                </button>
      ...
      <style>{`
        ...
        .sync-status-message.approved {
          background-color: #d1fae5;
          color: #065f46;
          border: 1px solid #6ee7b7;
        }

        .sync-status-message.approved svg {
          color: #059669;
          flex-shrink: 0;
          margin-top: 2px;
        }

        .sync-status-message.declined {
          background-color: #fee2e2;
          color: #991b1b;
          border: 1px solid #fca5a5;
        }

        .sync-status-message.declined svg {
          color: #dc2626;
          flex-shrink: 0;
          margin-top: 2px;
        }

        .sync-status-message.declined strong {
          display: block;
          margin-bottom: 8px;
          font-weight: 600;
        }

        .sync-status-message.declined p {
          margin: 0;
          font-style: italic;
        }
        ...
        /* Success Modal Styles - Strictly Matching rbc.jsx */
        .success-modal-overlay {
          position: fixed;
          top: 0;
          left: 0;
