...
const Notification = () => {
  ...
  // Sample notifications data for donors
  const notifications = [
    {
      id: 1,
      status: 'confirmed',
      title: 'Blood Donation Appointment Confirmed',
      message: 'Your blood donation appointment has been confirmed for October 22, 2025 at 9:00 AM.',
    ...
    },
    {
      ...
      message: 'Your blood donation appointment scheduled for October 20 has been cancelled.',
      requestor: 'Regional Blood Center',
    ...
    },
    {
      ...
      message: 'Your blood donation appointment request is pending confirmation. We will notify you once confirmed.',
      requestor: 'Regional Blood Center',
    ...
    },
    {
      ...
      message: 'You are eligible to donate blood again. Schedule your next appointment today!',
      requestor: 'Regional Blood Center',
  ...
  const getFilteredNotifications = () => {
    ...
    const sorted = [...filtered].sort((a, b) => {
      switch (sortBy) {
        ...
        case 'status':
          const statusOrder = { 'pending': 0, 'warning': 1, 'reminder': 2, 'confirmed': 3, 'cancelled': 4, 'info': 5 };
  ...
  const getCounts = () => {
    return {
      ...
      reminder: notifications.filter(n => n.status === 'reminder').length,
  ...
  return (
    <div className="notification-content">
      ...
      <div className="notification-header">
        <h1 className="notification-title" style={{fontSize: '24px', color: '#165C3C', fontWeight: 'bold', fontFamily: 'Barlow'}}>My Notifications</h1>
        <p className="notification-subtitle">Updates & Alerts</p>
      </div>
