  ...
  const loadAppointments = async () => {
    try {
      ...
      if (typeof window !== 'undefined' && window.electronAPI) {
        // Load regular appointments from organization DB
        ...
        const partnershipAppointments = partnershipRequests.map(req => {
          ...
          if (req.status === 'approved') {
            ...
            appointmentStatus = 'scheduled'; // pending status
          }
        ...
        setAppointments([
          ...
          },
          {
            ...
            time: '9:00',
            type: 'blood-donation',
            notes: 'Partnership meeting for organization blood drive',
            status: 'confirmed',
            contactInfo: {
              lastName: 'Buloy',
              email: 'buloy@xyzorg.org.ph',
              phone: '+63 918 765 4321',
              address: 'Xavier University Campus',
              type: 'organization'
            }
          },
          {
            ...
            contactInfo: {
              ...
              phone: '+63 918 765 4321',
              address: 'Regional Blood Center, CDO',
              type: 'individual'
            }
          },
          {
            id: 4,
            title: 'Blood Drive - Capitol University',
            date: '2025-10-02',
            time: '14:00',
            type: 'blood-donation',
            notes: 'University blood drive event',
            status: 'confirmed',
            contactInfo: {
              lastName: 'Reyes',
              email: 'reyes@capitol.edu.ph',
              phone: '+63 918 765 4321',
              address: 'Capitol University, CDO',
              type: 'organization'
            }
          },
          {
            id: 5,
            title: 'Community Blood Drive - Cogon',
            date: '2025-10-06',
            time: '11:00',
            type: 'blood-donation',
            notes: 'Community blood donation event',
            status: 'confirmed',
            contactInfo: {
              lastName: 'Martinez',
              email: 'martinez@cogon.gov.ph',
              phone: '+63 918 765 4321',
              address: 'Barangay Cogon, CDO',
              type: 'barangay'
            }
          },
          {
            id: 6,
            title: 'Blood Drive - Mindanao University',
            date: '2025-10-12',
            time: '8:00',
            type: 'blood-donation',
            notes: 'Weekend blood drive',
            status: 'confirmed',
            contactInfo: {
              lastName: 'Garcia',
              email: 'garcia@msu.edu.ph',
              phone: '+63 918 765 4321',
              address: 'Mindanao State University, CDO',
              type: 'organization'
            }
          },
          {
            id: 7,
            title: 'Blood Drive Partnership - Macasandig',
            date: '2025-10-22',
            time: '15:00',
            type: 'blood-donation',
            notes: 'Month end blood drive event',
            status: 'confirmed',
            contactInfo: {
              lastName: 'Santos',
              email: 'santos@macasandig.gov.ph',
              phone: '+63 918 765 4321',
              address: 'Barangay Macasandig, CDO',
              type: 'barangay'
            }
          },
          {
            ...
            time: '13:00',
            type: 'blood-donation',
            notes: 'Special emergency blood drive',
            status: 'confirmed',
            contactInfo: {
              lastName: 'Fernandez',
              email: 'fernandez@hospital.org.ph',
              phone: '+63 918 765 4321',
              address: 'Northern Mindanao Medical Center',
              type: 'organization'
            }
          }
        ]);
