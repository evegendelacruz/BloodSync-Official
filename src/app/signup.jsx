...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      if (result.success && result.isFirstUser) {
        // First user is automatically an admin and logged in
        setSuccess("Registration successful! You are the first Admin. Redirecting to dashboard...");
        ...
        // Subsequent users need verification
        setSuccess(
      ...
      // Clear form in both success cases
      setFormData({
        fullName: "",
        role: "",
        email: "",
