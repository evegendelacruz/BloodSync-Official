...
const CalendarOrg = () => {
  ...
  // Sample events data matching your application's blood center context
  const events = [
    {
      id: 1,
      title: 'Blood Drive - Metro Hospital',
      date: '2025-09-22',
      time: '8:00 AM - 5:00 PM',
      location: 'Metro Hospital Main Campus, CDO',
      type: 'blood-drive',
      participants: 45,
      status: 'confirmed'
    },
    {
      id: 2,
      title: 'Regional Blood Center Partnership',
      date: '2025-09-25',
    ...
    },
    {
      ...
      location: 'Northern Mindanao Medical Center',
      type: 'emergency',
      participants: 1,
      status: 'urgent'
    },
    {
      ...
      location: 'Regional Blood Center Conference Room',
      type: 'meeting',
      participants: 8,
      status: 'confirmed'
    }
