...
import { Filter, Search, Calendar, ChevronLeft, ChevronRight, Clock, MapPin, Users, BarChart3, X, AlertCircle } from 'lucide-react';
...
const CalendarPage = () => {
  ...
  const getEventStatus = (dateStr, status) => {
    ...
    // If pending, return pending regardless of date
  ...
  const events = appointments
    .filter(apt => apt.status === 'approved' || apt.status === 'confirmed' || apt.status === 'cancelled' || apt.status === 'pending' || apt.status === 'declined' || apt.status === 'scheduled')
    .map(apt => ({
  ...
  return (
    <div className="calendar-org-content">
      ...
      <div className="calendar-header">
        <h1 className="calendar-title">Partnered Organization</h1>
        ...
        <div className="monthly-report-container">
          <div className="report-header">
            ...
            <div className="report-stats">
              ...
              <div className="stat-card">
                <div className="stat-value">{monthlyReportData.reduce((sum, m) => sum + m.pending, 0)}</div>
