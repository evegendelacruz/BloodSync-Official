...
const MailOrg = () => {
  ...
  const buildEmailBody = (notification) => {
    ...
    const lines = [
      ...
      `Date Submitted: ${new Date(notification.created_at).toLocaleDateString()}`,
