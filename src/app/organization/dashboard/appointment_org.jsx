              ...
              <div style={{ lineHeight: '1.6', fontFamily: 'Barlow' }}>
                ...
                {currentAppointment.status && (
                  <div style={{ marginBottom: '15px' }}>
                    ...
                    <div style={{ marginTop: '5px' }}>
                      <span style={{
                        backgroundColor: `${getStatusColor(currentAppointment.status)}15`,
                        ...
                        fontWeight: '600',
                        fontFamily: 'Barlow',
                        border: `1px solid ${getStatusColor(currentAppointment.status)}`,
                ...
                {!isEditingAppointment ? (
                  <>
                    ...
                    <button
                      ...
                      style={{
                        background: currentAppointment.status === 'pending' ? '#2e7d32' : '#cccccc',
                        color: 'white',
                        border: 'none',
                        padding: '10px 20px',
                        borderRadius: '6px',
                        ...
                        fontWeight: '700',
                        fontFamily: 'Barlow',
                        cursor: currentAppointment.status === 'pending' ? 'pointer' : 'not-allowed',
                        transition: 'background-color 0.2s',
                        opacity: currentAppointment.status === 'pending' ? 1 : 0.6
                      }}
                      onMouseEnter={(e) => {
                        if (currentAppointment.status === 'pending') {
