...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  checkAndCreateStockLevelNotifications: async () => {
    try {
      return await ipcRenderer.invoke('db:checkAndCreateStockLevelNotifications');
    } catch (error) {
      console.error('Preload Error - checkAndCreateStockLevelNotifications:', error);
      throw error;
    }
  },
  ...
  getUserPermissions: async (userId) => {
    try {
      return await ipcRenderer.invoke('db:getUserPermissions', userId);
    } catch (error) {
      console.error('Preload Error - getUserPermissions:', error);
      throw error;
    }
  },
  ...
  updateUserPermissions: async (userId, permissions) => {
    try {
      return await ipcRenderer.invoke('db:updateUserPermissions', userId, permissions);
    } catch (error) {
      console.error('Preload Error - updateUserPermissions:', error);
      throw error;
    }
  },
...
updateNotificationStatusWithReason: async (notificationId, status, userName = 'Central System Admin', reason) => {
  ...
  // Password and Phone Management - RBC
  verifyPasswordRBC: async (userId, password) => {
    try {
      return await ipcRenderer.invoke('db:verifyPasswordRBC', userId, password);
    } catch (error) {
      console.error('Preload Error - verifyPasswordRBC:', error);
      throw error;
    }
  },

  updateUserPasswordRBC: async (userId, newPassword) => {
    try {
      return await ipcRenderer.invoke('db:updateUserPasswordRBC', userId, newPassword);
    } catch (error) {
      console.error('Preload Error - updateUserPasswordRBC:', error);
      throw error;
    }
  },

  sendPasswordResetOTPRBC: async (email) => {
    try {
      return await ipcRenderer.invoke('db:sendPasswordResetOTPRBC', email);
    } catch (error) {
      console.error('Preload Error - sendPasswordResetOTPRBC:', error);
      throw error;
    }
  },

  verifyPasswordResetOTPRBC: async (email, otp) => {
    try {
      return await ipcRenderer.invoke('db:verifyPasswordResetOTPRBC', email, otp);
    } catch (error) {
      console.error('Preload Error - verifyPasswordResetOTPRBC:', error);
      throw error;
    }
  },

  updatePhoneNumberRBC: async (userId, phoneNumber) => {
    try {
      return await ipcRenderer.invoke('db:updatePhoneNumberRBC', userId, phoneNumber);
    } catch (error) {
      console.error('Preload Error - updatePhoneNumberRBC:', error);
      throw error;
    }
  },

  sendPhoneVerificationOTPRBC: async (phoneNumber) => {
    try {
      return await ipcRenderer.invoke('db:sendPhoneVerificationOTPRBC', phoneNumber);
    } catch (error) {
      console.error('Preload Error - sendPhoneVerificationOTPRBC:', error);
      throw error;
    }
  },

  verifyPhoneOTPRBC: async (phoneNumber, otp) => {
    try {
      return await ipcRenderer.invoke('db:verifyPhoneOTPRBC', phoneNumber, otp);
    } catch (error) {
      console.error('Preload Error - verifyPhoneOTPRBC:', error);
      throw error;
    }
  },

  updateEmailRBC: async (userId, newEmail) => {
    try {
      return await ipcRenderer.invoke('db:updateEmailRBC', userId, newEmail);
    } catch (error) {
      console.error('Preload Error - updateEmailRBC:', error);
      throw error;
    }
  },

  // Password and Phone Management - ORG
  verifyPassword: async (userId, password) => {
    try {
      return await ipcRenderer.invoke('db:verifyPassword', userId, password);
    } catch (error) {
      console.error('Preload Error - verifyPassword:', error);
      throw error;
    }
  },
  ...
  updateUserPassword: async (userId, newPassword) => {
    try {
      return await ipcRenderer.invoke('db:updateUserPassword', userId, newPassword);
    } catch (error) {
      console.error('Preload Error - updateUserPassword:', error);
      throw error;
    }
  },
  ...
  sendPasswordResetOTP: async (email) => {
    try {
      return await ipcRenderer.invoke('db:sendPasswordResetOTP', email);
    } catch (error) {
      console.error('Preload Error - sendPasswordResetOTP:', error);
      throw error;
    }
  },
  ...
  verifyPasswordResetOTP: async (email, otp) => {
    try {
      return await ipcRenderer.invoke('db:verifyPasswordResetOTP', email, otp);
    } catch (error) {
      console.error('Preload Error - verifyPasswordResetOTP:', error);
      throw error;
    }
  },
  ...
  updatePhoneNumber: async (userId, phoneNumber) => {
    try {
      return await ipcRenderer.invoke('db:updatePhoneNumber', userId, phoneNumber);
    } catch (error) {
      console.error('Preload Error - updatePhoneNumber:', error);
      throw error;
    }
  },
  ...
  sendPhoneVerificationOTP: async (phoneNumber) => {
    try {
      return await ipcRenderer.invoke('db:sendPhoneVerificationOTP', phoneNumber);
    } catch (error) {
      console.error('Preload Error - sendPhoneVerificationOTP:', error);
      throw error;
    }
  },
  ...
  verifyPhoneOTP: async (phoneNumber, otp) => {
    try {
      return await ipcRenderer.invoke('db:verifyPhoneOTP', phoneNumber, otp);
    } catch (error) {
      console.error('Preload Error - verifyPhoneOTP:', error);
      throw error;
    }
  },
  ...
  getAllDonorRecordsMain: async () => {
     try {
       return await ipcRenderer.invoke('db:getAllDonorRecordsMain');    } catch (error) {
...
getPendingSyncRequests: async () => {
  ...
  updateSyncRequestStatus: async (organization, userName, status, by, reason = null) => {
    try {
      return await ipcRenderer.invoke('db:updateSyncRequestStatus', organization, userName, status, by, reason);
    } catch (error) {
...
// Add getRbcUserLogs to electronAPI
contextBridge.exposeInMainWorld('electronAPI', {
  ...window.electronAPI,
  getRbcUserLogs: async (userId, limit = 100, offset = 0) => {
    try {
      return await ipcRenderer.invoke('db:getRbcUserLogs', userId, limit, offset);
    } catch (error) {
      console.error('Preload Error - getRbcUserLogs:', error);
      throw error;
    }
  }
});